...
def nq_search(ds):
    query_path = '/checkpoint/amaia/explore/rulin/truth_teller_index/examples/nq_open.jsonl'
    output_path = '/checkpoint/amaia/explore/rulin/truth_teller_index/examples/nq_open_ip_searched_4096_contriever.jsonl'
    data = []
